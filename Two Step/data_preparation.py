...
df_train = pd.read_csv('/home/sohampoddar/HDD2/utsav/Dataset/train.csv')
df_test = pd.read_csv('/home/sohampoddar/HDD2/utsav/Data/val_data_with_labels_desc.csv')
...
df_train["tweet_filtered"] = df_train["text"].apply(preprocess)
df_test["tweet_filtered"] = df_test["text"].apply(preprocess)
...
# df_train.to_csv('/home/sohampoddar/HDD2/utsav/Dataset/train_caves.csv')
df_test.to_csv('/home/sohampoddar/HDD2/utsav/Dataset/test_caves_new.csv')